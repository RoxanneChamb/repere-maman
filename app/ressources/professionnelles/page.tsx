...
function ThemeLink({ theme }: { theme: Theme }) {
  ...
  return (
    <Link
      href={theme.href}
      className="group block rounded-[26px] border border-[#A58B71]/15 bg-[#F9F6F2] p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-[#7A816C]/35 hover:shadow-md md:rounded-[28px] md:p-6"
    >
      <div className="grid grid-cols-[40px_1fr] items-start gap-3 md:grid-cols-[42px_1fr] md:gap-4">
        ...
        <div className="min-w-0">
          <h3 className="font-[var(--font-title)] text-[1.7rem] font-semibold leading-tight text-[#2F2A26] md:text-[30px]">
            {theme.title}
          </h3>
...
function ReferenceLink({ reference }: { reference: Reference }) {
  return (
    <Link
      ...
      className="group block rounded-[24px] border border-white/15 bg-white/10 p-4 transition hover:-translate-y-0.5 hover:border-white/40 hover:bg-white/14 md:rounded-[26px] md:p-5"
    >
      <div className="grid grid-cols-[38px_1fr] items-start gap-3 md:grid-cols-[40px_1fr] md:gap-4">
    ...
    <main className="min-h-screen overflow-hidden bg-[#E5DFD6] text-[#2F2A26]">
      <section className="relative mx-auto max-w-6xl px-5 py-8 md:px-8 md:py-20">
        ...
        <div className="relative">
          ...
          <div className="mt-7 overflow-hidden rounded-[32px] border border-[#A58B71]/15 bg-[#F9F6F2]/70 p-4 shadow-sm md:mt-10 md:rounded-[48px] md:p-8">
            <div className="grid gap-8 md:grid-cols-[0.95fr_1.05fr] md:items-center md:gap-10">
              <div className="md:p-2">
                ...
                <p className="mt-5 max-w-xl font-[var(--font-body)] text-[16px] leading-8 text-[#5E5A52]">
                  Une sélection de ressources cliniques pour soutenir
                  l’éducation, l’orientation, la préparation d’un suivi et le
                  raisonnement professionnel en allaitement.
                </p>
              </div>

              <div className="overflow-hidden rounded-[28px] border border-[#D1A9A5]/35 bg-[#E5DFD6] p-2 shadow-sm md:rounded-[38px]">
                <Image
                  src="/ressources-professionnelles-clinique.png"
                  alt="Professionnelle de la santé auprès d’un nouveau-né"
                  width={900}
                  height={1100}
                  priority
                  className="block h-[260px] w-full rounded-[22px] object-cover object-center sm:h-[380px] md:h-[520px] md:rounded-[30px]"
                />
              </div>
            </div>
          </div>
          ...
          <section className="mt-10 grid gap-6 md:mt-12 md:grid-cols-[0.75fr_1.25fr] md:gap-8">
            <div className="rounded-[30px] border border-[#A58B71]/15 bg-[#EDE7DD] p-5 md:rounded-[42px] md:p-8">
          ...
          <section className="mt-10 rounded-[30px] border border-[#A58B71]/15 bg-[#F9F6F2] p-5 shadow-sm md:mt-12 md:rounded-[42px] md:p-8">
            <div className="grid gap-7 md:grid-cols-[0.75fr_1.25fr] md:gap-8">
              ...
              <div className="rounded-[26px] bg-[#E5DFD6]/55 p-5 md:rounded-[28px]">
                <p className="font-[var(--font-body)] text-sm leading-7 text-[#5E5A52]">
                  ...
                  l’évaluation clinique doit toujours tenir compte du contexte,
                  de l’âge du bébé, du poids, des boires, des couches, de l’état
                  général, de la douleur, des signes systémiques et des
                  protocoles locaux.
                </p>
              </div>
            </div>
          ...
          <section className="mt-10 rounded-[30px] bg-[#7A816C] p-5 text-white shadow-sm md:mt-12 md:rounded-[42px] md:p-8">
