    ...
    <main className="min-h-screen bg-[#E5DFD6] text-[#2F2A26]">
      ...
      <section className="mx-auto max-w-6xl px-5 pb-14 md:px-8 md:pb-20">
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-[34px] bg-[#F9F6F2] p-5 shadow-sm md:p-7">
      ...
      <section className="mx-auto max-w-6xl px-5 pb-14 md:px-8 md:pb-20">
        <div className="grid gap-10 md:grid-cols-[0.75fr_1.25fr] md:items-start">
          ...
          <div className="rounded-[34px] bg-[#F9F6F2] p-5 shadow-sm md:rounded-[42px] md:p-8">
      ...
      <section className="mx-auto max-w-6xl px-5 pb-14 md:px-8 md:pb-20">
        <div className="rounded-[34px] bg-[#7A816C] p-5 text-white shadow-sm md:rounded-[42px] md:p-10">
          <div className="grid gap-8 md:grid-cols-[0.8fr_1.2fr] md:items-start">
            <div>
              ...
              <p className="mt-5 font-[var(--font-body)] text-sm leading-7 text-white/80">
            ...
            <div className="grid gap-4">
              {priorites.map((item) => (
                <div
                  key={item.title}
                  className="rounded-[28px] border border-white/15 bg-white/10 p-5"
                >
      ...
      <section className="mx-auto max-w-6xl px-5 pb-14 md:px-8 md:pb-20">
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-[34px] bg-[#D1A9A5] p-5 md:rounded-[42px] md:p-8">
          ...
          <div className="rounded-[34px] bg-[#F9F6F2] p-5 shadow-sm md:rounded-[42px] md:p-8">
            ...
            <div className="mt-7 rounded-[28px] border border-[#AE6965]/25 bg-[#AE6965]/10 p-5">
        ...
        <div className="grid gap-10 md:grid-cols-[0.75fr_1.25fr] md:items-start">
          ...
          <div className="grid gap-4">
            {surveiller.map((item) => (
              <div
                key={item}
                className="rounded-[28px] bg-[#F9F6F2] p-5 shadow-sm"
              >
                <p className="font-[var(--font-body)] text-sm leading-7 text-[#4F4943]">
                  {item}
                </p>
      ...
      <section className="mx-auto max-w-6xl px-5 pb-14 md:px-8 md:pb-20">
  <div className="rounded-[34px] bg-[#2F2A26] p-5 text-white shadow-sm md:rounded-[42px] md:p-10">
    <div className="grid gap-8 md:grid-cols-[0.8fr_1.2fr] md:items-center">
      <div>
        ...
        <p className="mt-5 max-w-md font-[var(--font-body)] text-sm leading-7 text-white/78">
          ...
          indication possible, protection de l’allaitement, choix du supplément,
          méthode d’administration et critères de réévaluation.
        </p>
      </div>

      <div className="rounded-[30px] border border-white/15 bg-white/10 p-5 md:p-7">
        <div className="grid gap-4">
          <div className="flex gap-3">
            ...
            <p className="font-[var(--font-body)] text-sm leading-7 text-white/80">
              Pensé pour soutenir le raisonnement clinique, sans remplacer les
              protocoles locaux ni l’évaluation individualisée.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            <CheckCircle2 className="mt-1 h-5 w-5 shrink-0 text-[#D1A9A5]" />
            <p className="font-[var(--font-body)] text-sm leading-7 text-white/80">
              Format PDF multipage, facile à imprimer, partager ou conserver
              comme aide-mémoire.
            </p>
          </div>
...
<section className="mx-auto max-w-6xl px-5 pb-14 md:px-8 md:pb-20">
  <div className="rounded-[34px] bg-[#F9F6F2] p-5 shadow-sm md:rounded-[42px] md:p-8">
    <div className="grid gap-8 md:grid-cols-[0.85fr_1.15fr] md:items-end">
      <div>
        ...
        <p className="mt-5 max-w-md font-[var(--font-body)] text-sm leading-7 text-[#5E5A52]">
          Un repère synthèse pour guider l’évaluation, identifier une indication
          possible, choisir le supplément le plus approprié et protéger
          l’allaitement tout au long du processus.
        </p>
      </div>

      <div className="rounded-[28px] border border-[#A58B71]/20 bg-[#FBF8F3] p-5">
        <p className="font-[var(--font-body)] text-sm leading-7 text-[#5E5A52]">
          <span className="font-bold text-[#2F2A26]">Rappel :</span> cet outil
          soutient le raisonnement clinique. Il ne remplace pas une évaluation
          individualisée, les protocoles locaux, ni le jugement clinique.
        </p>
    ...
    <div className="mt-8 grid gap-4 md:gap-5">
      {/* Étape 1 */}
      <div className="rounded-[30px] border border-[#7A816C]/20 bg-[#7A816C]/10 p-5 md:p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="max-w-3xl">
            ...
            <h3 className="mt-4 font-[var(--font-title)] text-3xl font-semibold leading-tight text-[#2F2A26]">
              Évaluer la dyade
            </h3>

            <p className="mt-3 font-[var(--font-body)] text-sm leading-7 text-[#4F4943]">
              Examiner l’état général du bébé, les boires, les couches, le poids,
              la somnolence, les signes d’ictère, la douleur maternelle et
      ...
      {/* Étape 2 - question */}
      <div className="rounded-[30px] border border-[#AE6965]/20 bg-[#AE6965]/10 p-5 md:p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-3 font-[var(--font-body)] text-sm leading-7 text-[#4F4943]">
              Rechercher des signes d’alerte : difficulté à se réveiller, peu de
              boires, peu de couches, faiblesse, hypoglycémie suspectée,
              déshydratation, ictère important ou détérioration clinique.
            </p>
          </div>
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          <div className="rounded-[24px] bg-white p-4">
            ...
            <p className="mt-2 font-[var(--font-body)] text-sm leading-7 text-[#4F4943]">
              Évaluation rapide, prise en charge selon le contexte clinique et
              supplémentation si nécessaire selon les protocoles locaux.
            </p>
          </div>
          ...
          <div className="rounded-[24px] bg-white p-4">
            ...
            <p className="mt-2 font-[var(--font-body)] text-sm leading-7 text-[#4F4943]">
              Poursuivre l’analyse pour déterminer s’il y a une indication réelle
              de supplémentation.
            </p>
          </div>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {algoSteps.slice(2).map((item) => {
          ...
          return (
            <div
              key={item.step}
              className={`rounded-[28px] border p-5 shadow-sm ${styles}`}
            >
              <div className={`inline-flex rounded-full px-3 py-1 ${badge}`}>
                <span className="font-[var(--font-body)] text-xs font-bold uppercase tracking-[0.14em]">
                  Étape {item.step}
                </span>
              </div>

              <h3 className="mt-4 font-[var(--font-title)] text-2xl font-semibold leading-tight text-[#2F2A26]">
                {item.title}
              </h3>
      ...
      <div className="mt-6 rounded-[30px] border border-[#A58B71]/20 bg-[#FBF8F3] p-5 md:p-6">
        <p className="font-[var(--font-body)] text-xs font-bold uppercase tracking-[0.18em] text-[#AE6965]">
          Résultat attendu
        </p>

        <h3 className="mt-3 font-[var(--font-title)] text-3xl font-semibold leading-tight text-[#2F2A26]">
          Un plan clair, proportionné et réévaluable.
        </h3>

        <p className="mt-3 max-w-4xl font-[var(--font-body)] text-sm leading-7 text-[#5E5A52]">
          La supplémentation devrait toujours répondre à un besoin clinique,
          utiliser le supplément le plus approprié, préserver la stimulation
          lactée et prévoir une réévaluation rapprochée pour ajuster ou cesser
          le plan lorsque possible.
        </p>
      </div>
    </div>
  </div>
          ...
          <div className="mt-6 grid gap-4">
            {sources.map((source) => (
              <Link
                ...
                className="group rounded-[28px] border border-[#A58B71]/20 bg-[#FBF8F3] p-5 transition hover:border-[#AE6965]/45"
              >
