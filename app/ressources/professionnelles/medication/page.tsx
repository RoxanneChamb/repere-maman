...
function ThemeLink({ theme }: { theme: Theme }) {
  ...
  return (
    <article className="rounded-[28px] border border-[#A58B71]/18 bg-[#F9F6F2] p-5 shadow-sm transition hover:border-[#7A816C]/40 md:p-6">
...
function ReferenceLink({ reference }: { reference: Reference }) {
  return (
    <article className="rounded-[28px] border border-white/15 bg-white/10 p-5 transition hover:border-white/40 hover:bg-white/14 md:p-6">
      <div className="grid grid-cols-[42px_1fr] items-start gap-3 md:grid-cols-[46px_1fr] md:gap-4">
