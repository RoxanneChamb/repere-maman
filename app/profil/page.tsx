  ...
  if (loading) {
    return (
      <main className="min-h-screen overflow-hidden bg-[#E5DFD6] text-[#2F2A26]">
        <section className="relative mx-auto max-w-5xl px-5 py-8 md:px-8 md:py-20">
          ...
          <div className="relative rounded-[32px] bg-[#F9F6F2] p-5 shadow-sm md:rounded-[42px] md:p-10">
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#E5DFD6] text-[#2F2A26]">
      <section className="relative mx-auto flex min-h-[calc(100vh-88px)] max-w-6xl items-center px-5 py-8 md:px-8 md:py-20">
        ...
        <div className="relative grid w-full gap-8 md:grid-cols-[0.85fr_1.15fr] md:items-center md:gap-10">
          <div>
            ...
            <div className="mt-6 rounded-[28px] border border-[#A58B71]/20 bg-[#F9F6F2]/60 p-4 shadow-sm backdrop-blur md:mt-7 md:flex md:gap-3 md:border-t md:bg-transparent md:p-0 md:pt-5 md:shadow-none">
              <Mail className="h-5 w-5 shrink-0 text-[#7A816C] md:mt-1" />

              <p className="mt-3 break-words font-[var(--font-body)] text-sm leading-7 text-[#5E5A52] md:mt-0">
                Connectée avec :{" "}
          ...
          <div className="rounded-[32px] border border-[#A58B71]/15 bg-[#F9F6F2] p-5 shadow-sm md:rounded-[42px] md:p-9">
            ...
            <form
              className="mt-6 grid gap-4 md:mt-7 md:gap-5"
              onSubmit={(e) => {
                e.preventDefault();
                saveProfile();
              }}
            >
              ...
              <button
                type="submit"
                disabled={saving}
                className="mt-2 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#7A816C] px-5 py-4 font-[var(--font-body)] text-xs font-bold uppercase tracking-[0.14em] text-white shadow-sm transition hover:bg-[#68705C] disabled:cursor-not-allowed disabled:opacity-60"
              >
